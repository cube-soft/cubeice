...
static const char *kUserErrorMessage  = "ERROR: Incorrect command line";
static const char *kCannotFindListFile = "ERROR: Cannot find listfile";
static const char *kIncorrectListFile = "ERROR: Incorrect item in listfile";
static const char *kIncorrectWildCardInListFile = "ERROR: Incorrect wildcard in listfile";
static const char *kIncorrectWildCardInCommandLine  = "ERROR: Incorrect wildcard in command line";
static const char *kTerminalOutError = "ERROR: I won't write compressed data to a terminal";
static const char *kSameTerminalError = "ERROR: I won't write data and program's messages to same terminal";
static const char *kEmptyFilePath = "ERROR: Empty file path";
