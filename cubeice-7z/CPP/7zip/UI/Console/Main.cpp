...
static const char *kNoFormats = "ERROR: 7-Zip cannot find the code that works with archives.";
static const char *kUnsupportedArcTypeMessage = "ERROR: Unsupported archive type";
